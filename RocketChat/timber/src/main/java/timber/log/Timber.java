...
public final class Timber {
    ...
    /**
     * TLog at {@code priority} a message with optional format args.
     */
    ...
    /**
     * TLog at {@code priority} an exception and a message with optional format args.
     */
     ...
     */
    public static void plant(Tree tree, TLog log) {
        Timber.log = log;
        if (tree == null) {
    ...
    public static abstract class Tree {
         ...
         */
        public void v(String message, Object... args) {
            prepareLog(TLog.VERBOSE, null, message, args);
        }
         ...
         */
        public void v(Throwable t, String message, Object... args) {
            prepareLog(TLog.VERBOSE, t, message, args);
        }
         ...
         */
        public void d(String message, Object... args) {
            prepareLog(TLog.DEBUG, null, message, args);
        }
         ...
         */
        public void d(Throwable t, String message, Object... args) {
            prepareLog(TLog.DEBUG, t, message, args);
        }
         ...
         */
        public void i(String message, Object... args) {
            prepareLog(TLog.INFO, null, message, args);
        }
         ...
         */
        public void i(Throwable t, String message, Object... args) {
            prepareLog(TLog.INFO, t, message, args);
        }
         ...
         */
        public void w(String message, Object... args) {
            prepareLog(TLog.WARN, null, message, args);
        }
         ...
         */
        public void w(Throwable t, String message, Object... args) {
            prepareLog(TLog.WARN, t, message, args);
        }
         ...
         */
        public void e(String message, Object... args) {
            prepareLog(TLog.ERROR, null, message, args);
        }
         ...
         */
        public void e(Throwable t, String message, Object... args) {
            prepareLog(TLog.ERROR, t, message, args);
        }
         ...
         */
        public void wtf(String message, Object... args) {
            prepareLog(TLog.ASSERT, null, message, args);
        }
         ...
         */
        public void wtf(Throwable t, String message, Object... args) {
            prepareLog(TLog.ASSERT, t, message, args);
        }
        ...
        private String getStackTraceString(Throwable t) {
            // Don't replace this with TLog.getStackTraceString() - it hides
         ...
         *
         * @param priority TLog level. See {@link TLog} for constants.
    ...
    public static class DebugTree extends Tree {
         ...
         * {@link TLog#println(int, String, String) TLog.println()} or
         * {@link TLog#wtf(String, String) TLog.wtf()} for logging.
         * <p>
         * {@inheritDoc}
         */
        @Override
        protected void log(int priority, String tag, String message, Throwable t) {
            ...
            // Split by line, then ensure each line can fit into TLog's maximum length.
